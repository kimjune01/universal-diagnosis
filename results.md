...
|---------|----------|-----------|----------|--------|---------|---------------|---------|
| SPRB | dying_pivoted | PASS | BLA submission for TA-ERT | by 2026-12-31 | Bull | No (soap-a) | **Pending** |
| ATYR | dying_pivoted | PASS | New sarcoidosis trial announced | by 2026-09-30 | Bear | No (soap-a) | **Pending** |
| INMB | dying_pivoted | FAIL | CORDStrom MAA to UK MHRA | by 2026-09-30 | Bear | Yes | **Pending** |

## Scorecard

Resolves when:
- **ATYR**: by September 30, 2026 — check aTyr press releases / SEC 8-K for new sarcoidosis trial announcement
- **INMB**: by September 30, 2026 — check INmune Bio press releases / SEC 8-K for MAA submission acknowledgment
- **SPRB**: by December 31, 2026 — check Spruce Biosciences press releases / SEC 8-K for BLA submission acknowledgment

Scoring rule: check the resolution source on window_end. If pass_condition is met, outcome = hit. If not, outcome = miss. No judgment.
